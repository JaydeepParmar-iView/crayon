...
export default function Jobs() {
  ...
  // console.log("ALL INDUSTRY", allIndustries);
  ...
  const onChangeFilterJobType = (selectedFilter) => {
    ...
    getJobList(filters, jobs, filtersJobStage, filtersType, "", searchedJobs);
  };
  ...
  return (
    ...
    >
      ...
      <Grid xs={12} sm={6} md={8} lg={9} xl={10}>
        ...
        />
        <InfiniteScroll
          key={`${filters} + ${filtersJobType} + ${filtersJobStage} + ${filtersType}+${searchedJobs}`}
