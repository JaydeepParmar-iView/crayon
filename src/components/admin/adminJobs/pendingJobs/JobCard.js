...
export default function ActiveJobCard({ index, jobContent, onManageTalent }) {
          ...
          <Box className="contentBoxLeft">
            ...
            <Box sx={{ mt: 1 }}>
              ...
              <Box sx={{ display: "flex", alignItems: "center", mt: 1 }}>
                ...
                {jobContent?.job_qualifications.map((qualifications, index) => {
                  return (
                    <SmallButton
                      minWidth="10px"
                      height={18}
                      color="grayButton"
                      borderRadius="5px"
                      label={qualifications?.qualification?.name}
                      mr="4px"
                    ></SmallButton>
                  );
                })}
