...
import { duplicateThejob, getManage, statusChange } from "../../../redux/employer/myJobsSlice";
    ...
    <>
      ...
      >
        <Box>
          ...
          >
            Job status: {manage == "active" && <SmallButton
              color="greenButton200"
              label={manage}
              mr={1}
            />}
            {manage == "pending" && <SmallButton
              color="orangeButton"
              label={manage}
              mr={1}
            />}
            {manage == "paused" && <SmallButton
              color="orangeButton"
              label={manage}
              mr={1}
            />}
            {manage == "closed" && <SmallButton
              color="redButton100"
              label={manage}
              mr={1}
            />}
      ...
      >
        <Box sx={style}>
          <Typography id="modal-modal-title" variant="h6" component="h2">
            Are you sure that you want to {temp == "a" && "Edit"}{temp == "b" && "Pause"}{temp == "c" && "Close"}{temp == "d" && "Duplicate"} this job?
          </Typography>
