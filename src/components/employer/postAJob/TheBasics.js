...
export default function TheBasics({ jobId, onSubmit, basic }) {
    ...
    <Box>
        ...
        >
          <Box sx={{ display: "flex", alignItems: "center" }}>
            ...
            >
              ...
              <Box>
                <Accordion sx={{width:200,backgroundColor:"#C19C47",boxShadow:"none"}}>
                  <AccordionSummary
                    expandIcon={<ExpandMoreIcon sx={{color:"white"}} />}
                    aria-controls="panel1a-content"
                    id="panel1a-header"
                  >
                    <Typography sx={{color:"white"}}>Show more details</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
      ...
      <Box>
        ...
        >
          ...
          <Box sx={{ display: "flex", flexDirection: "column", width: "50%", paddingLeft:"10px",paddingRight:"10px"}}>
           <InputLabel
              htmlFor="salary_id"
              sx={{
                color: "black",
            ...
            >
            {basicData.job_role_type == "freelance" ? i18n["postAJob.salaryRangeLable2"] : i18n["postAJob.salaryRangeLable"]}
            </InputLabel>
        ...
        value={rangeValue}
        onChange={basicData.job_role_type == "freelance" ? handleRangeSliderChange2 : handleRangeSliderChange}
        color="redButton100"
        valueLabelDisplay="auto"
        step={basicData.job_role_type == "freelance" && 1}
        valueLabelFormat={basicData.job_role_type == "freelance" ? rangeValueHandler2 : rangeValueHandler}
        getAriaValueText={basicData.job_role_type == "freelance" ? rangeValueHandler2 : rangeValueHandler}
        marks={basicData.job_role_type == "freelance" ? rangeMarks2 : rangeMarks}
      />
          </Box>
        </Box>
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", mb: 3 }}>
          ...
          <Box sx={{ display: "flex", flexDirection: "column", width: "50%" }}>
            ...
            <SelectMenu
              ...
              value={towns.find((val)=> val.town_id == basicData.town_id)?.name || ""}
              onHandleChange={handleChange}
              options={townsMain}
              sx={{ width: "95%" }}
