...
import { ALERT_TYPE, USER_TYPES ,AUTHORIZED_TAB_ITEMS_EMPLOYER,AUTHORIZED_TAB_ITEMS_CANDIDATE,PUBLIC_TAB_ITEMS,
  ...
  return (
    <Box>
      ...
      >
        ...
        >
         {i18n["login.s1"]}
          <a href={PrivacyPolicy} target="_blank" sx={{textDecoration:'none'}} >{i18n["login.s4"]}</a>
          {i18n["login.s3"]}
          <a href={TermsandServices} target="_blank">
            {i18n["login.s2"]}
          </a>
        </Typography>
