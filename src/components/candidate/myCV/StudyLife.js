...
export default function StudyLife({ onSubmit, study }) {
  ...
  console.log("FORM DATA", studyData);
  ...
  const handleSelectChange = (event, index) => {
    console.log(event, index);
    const newStudyData = JSON.parse(JSON.stringify(studyData));
    newStudyData.qualification[index]["year_ended"] = event.target.value.key;
    console.log(newStudyData);
    setStudyData(newStudyData);
    onSubmit("study", newStudyData);
  };
  ...
  const handleSelectChange3 = (event, id, name) => {
    const newStudyData = JSON.parse(JSON.stringify(studyData));
    newStudyData.otherdata["school_completed"] = id;
    setStudyData(newStudyData);
    onSubmit("study", newStudyData);
  };
  const handleSelectChange4 = (event, id, name) => {
    const newStudyData = JSON.parse(JSON.stringify(studyData));
    newStudyData.otherdata["association_completed"] = id;
    setStudyData(newStudyData);
    onSubmit("study", newStudyData);
  };
  ...
  const getInstitutionValue = (idx) => {
    const temp2 = institution.find(
      (val) => val.id === study[idx]?.institution_id
    );
    console.log("INSITTUTIOn", temp2);
  ...
  const getQualificationValue = (idx) => {
    const temp2 = qualification.find(
      (val) => val.id === study[idx]?.qualification_id
    );
    console.log(temp2);
  ...
  const getTypeQualificationVal = (idx) => {
    console.log(typeOfQualification);
    const temp2 = typeOfQualification.find(
      (val) => val.id === study[idx]?.qualificationtype_id
    );
    console.log(temp2);
    return temp2?.name || "";
  };
  ...
  const getSchoolValue = () => {
    const temp2 = school.find((val) => val.id === study[0]?.school_id);
    return temp2?.name || "";
  };

  const getAssociationValue = () => {
    const temp2 = association.find(
      (val) => val?.association_id === study[0]?.association_id
    );
    return temp2?.name || "";
  };
      ...
      <Box sx={{ pt: 6 }}>
        ...
        >
          ...
          <Box sx={{ width: "27%" }}>
            ...
            {console.log("INSIDE", studyData)}
            <Select
              id="school_year_end"
              name="school_year_end"
              defaultValue={studyData.school_year_ended}
              onChange={(event) => handleChange(event)}
              sx={{
                width: "100%",
                borderRadius: "25px",
        ...
        >
          ...
          <Box sx={{ width: "27%" }}>
            ...
            <Select
              ...
              name="association_year_end"
              onChange={(event) => handleChange(event)}
              defaultValue={studyData.association_year_end}
              sx={{
                width: "100%",
                borderRadius: "25px",
                height: "40px",
